...
# 访问渠道
http_referers = [
"https://www.baidu.com/s?key={query}",
"https://www.google.com/web?key={query}",
"https://cn.bing.com/search?key={query}",
]
...
def generate_log(count=10):
	...
	# f = open("/home/logs/log","w+")
    # 设置写出日志路径
	f = open("C:/Users/22516/Desktop/日志/05-使用Python脚本实时产生数据/05-使用Python脚本实时产生数据/data.log","a+")
	while count >= 1:
